...
const ProjectTaskKanbanModel = KanbanModel.extend({
    ...
    _readGroup: function (list) {
                    console.log("_readGroup is executed.");
                    const groupedBy = list.groupedBy[0];
                    const customDomain = [['qa_parent_id', '=', false]];
...
// import KanbanModel from 'web.KanbanModel';
// odoo.define('_project_kanban_inheir.QA_Subtasks', function (require) {
//     "use strict";
    
//     // var KanbanModel = require('web.KanbanModel');
//     var Domain = require('@web/core/domain');
//     console.log("Custom script for QA_Subtasks is loaded successfully.");
//     var ProjectTaskKanbanModel = KanbanModel.extend({
